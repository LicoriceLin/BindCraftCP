#!/usr/bin/env python
"""Run single hallucinations and save ColabDesign trajectory animations."""
...
def _advanced_dict(flat_settings: dict[str, Any]) -> dict[str, Any]:
    from epitopecraft.utils import BinderSettings, FilterSettings, TargetSettings
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Render ColabDesign hallucination trajectory animations."
    )
