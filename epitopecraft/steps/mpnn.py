...
from ..utils import GlobalSettings,NEST_SEP,_load_json_or_yaml
...
class MPNN(BaseStep):
    ...
    def init_penalty_recipes(self):
        bias_recipe_file=self.settings.adv.setdefault(
            'mpnn_bias_recipe','epitopecraft/pipelines/config/mpnn-default-recipe.json')
        bias_recipe=_load_json_or_yaml(bias_recipe_file)
